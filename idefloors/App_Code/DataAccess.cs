...
public static DataTable getCertificate(string Id, string Page, string Limit, ref int total)
    ...
    public static DataTable getFlash(string Id, string Page, string Limit, ref int total)
    {
        string _TableName = "Flash n";
        string _PK = "Id";
        string _FieldSelect = "n.*";
        string _Filter = "";
        if (Id != "" && Id != "-1")
    ...
    public static DataTable getProjectLogo(string Id, string Page, string Limit, ref int total)
    {
        string _TableName = "ProjectLogo n";
        string _PK = "Id";
        string _FieldSelect = "n.*";
        string _Filter = "";
        if (Id != "" && Id != "-1")
