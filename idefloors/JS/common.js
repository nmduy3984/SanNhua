function SlideNewProduct(tagHtmlId) {
    var options_new_product = {
    ...
    var jssor_slider_new_product = new $JssorSlider$(tagHtmlId, options_new_product);
}
function SlideFlashs(tagHtmlId) {
    ...
    var jssor_slider_flash = new $JssorSlider$(tagHtmlId, options_flash);
}
function SlideProjects(tagHtmlId){
    var options_footer = {
        $AutoPlay: true,                                    //[Optional] Whether to auto play, to enable slideshow, this option must be set to true, default value is false
    ...
    var jssor_slider_footer = new $JssorSlider$(tagHtmlId, options_footer);
}
function SlideReferences(tagHtmlId) {
    var _SlideshowTransitions = [
            //Fade in L
                { $Duration: 1200, x: 0.3, $During: { $Left: [0.3, 0.7] }, $Easing: { $Left: $JssorEasing$.$EaseInCubic, $Opacity: $JssorEasing$.$EaseLinear }, $Opacity: 2 }
            //Fade out R
    ...
    var options_flash = {
        ...
        $ThumbnailNavigatorOptions: {                       //[Optional] Options to specify and enable thumbnail navigator or not
            ...
            $ParkingPosition: 80                          //[Optional] The offset position to park thumbnail
        }
    };
    var jssor_slider_flash = new $JssorSlider$(tagHtmlId, options_flash);
}
function SlideProductDetail(tagHtmlId) {
    var _SlideshowTransitions = [
            //Fade in L
                { $Duration: 1200, x: 0.3, $During: { $Left: [0.3, 0.7] }, $Easing: { $Left: $JssorEasing$.$EaseInCubic, $Opacity: $JssorEasing$.$EaseLinear }, $Opacity: 2 }
            //Fade out R
