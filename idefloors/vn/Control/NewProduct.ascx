                        ...
                        $('#PopupNewProduct<%= productID %>').magnificPopup({
                            ...
                            image: {
                                ...
                                titleSrc: function (item) {
                                    ...
                                    return '<div style="float:left;padding-left:5px;color:#403d3b;font-size:12px;font-weight:normal;">' + arr[1] + '</div>' + arr[0] + '<div style="float:right;font-size:12px; font-weight:normal;"><a href="../../vn/Page/ProductByCategory.aspx?Id=<%= row["CategoryID"].ToString() %>" style="color:#6ab901;">Xem thêm&nbsp;&#187;</a></div>';
                                }
                            }
                        });
                    </script>
