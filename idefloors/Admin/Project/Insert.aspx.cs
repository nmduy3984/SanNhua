...
public partial class Admin_Project_Insert : System.Web.UI.Page
{
...
//                            Values(N'" + tieude + "',N'" + des + "',N'" + content + "','" + Img + "','" + Session["UserName"] + "','" + now.ToString() + "')";
            string sql = @"Insert into Projects(Title,[Description],Content,ImageUrl,UserCreated,CreatedDate,TitleEN,[DescriptionEN],ContentEN,TitleCAM,[DescriptionCAM],ContentCAM) 
