...
public partial class Admin_Project_QLProject : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
     ...
     protected void btnDelete_Click(object sender, EventArgs e)
     {
         ...
         Utilities.redirectClient(Page, "/Admin/Project/Delete.aspx?ID="+x);
     }
    protected void btnAdd_Click(object sender, EventArgs e)
    {
        Utilities.redirectClient(Page, "/Admin/Project/Insert.aspx");
    }
    private void showData()
    {
        ...
        dt = DataAccess.getProjects("-1", _Page, _Limit, ref total);
