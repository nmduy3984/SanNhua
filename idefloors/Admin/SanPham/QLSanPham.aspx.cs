...
public partial class Admin_SanPham_QLSanPham : System.Web.UI.Page
{
    public DataTable dtSanPham = new DataTable();
    ...
    private void showData()
    {
        ...
        dtSanPham = DataAccess.getSanPhamTheodanhmuc("-1", _Page, _Limit, ref total);
    ...
    protected void btnDelete_Click(object sender, EventArgs e)
    {
        ...
        Utilities.redirectClient(Page, "/Admin/SanPham/Delete.aspx?ID=" + x);
    }
    protected void btnAdd_Click(object sender, EventArgs e)
    {
        Utilities.redirectClient(Page, "/Admin/SanPham/Insert.aspx");
    }
}