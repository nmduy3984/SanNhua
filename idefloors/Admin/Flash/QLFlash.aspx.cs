...
public partial class Admin_Flash_QLFlash : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
     ...
     protected void btnDelete_Click(object sender, EventArgs e)
     {
         ...
         Utilities.redirectClient(Page, "/Admin/Flash/Delete.aspx?ID="+x);
     }
    protected void btnAdd_Click(object sender, EventArgs e)
    {
        Utilities.redirectClient(Page, "/Admin/Flash/Insert.aspx");
    }
    private void showData()
    {
        ...
        dt = DataAccess.getFlash("-1", _Page, _Limit, ref total);
