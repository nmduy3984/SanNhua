<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPages/AdminMaster.master" AutoEventWireup="true" CodeFile="QLProjectLogo.aspx.cs" Inherits="Admin_ProjectLogo_QLProjectLogo" %>
...
<div class="topPanel">
    <div class="floatLeft">
        ...
        <asp:LinkButton CssClass="btn_green" ForeColor="#ca0303" ID="btnDelete"
            ...
            runat="server">Xóa Logo</asp:LinkButton>
    ...
    <table class="table_Blue" id="mainData" style="min-width:600px" cellpadding="0" cellspacing="0">
        ...
        <tr>
            <td>
             ...
             <td>
                 <a href="Edit.aspx?ID=<%=dr["Id"]%>"><img  alt="idefloors.vn" height="150px" width="150px;" src="/Images/ProjectLogo/<%=dr["ImgUrl"]%>" /></a>
            </td> 
              <td>
                <%=dr["Link"].ToString()%>
            </td>
