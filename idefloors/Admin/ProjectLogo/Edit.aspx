<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPages/AdminMaster.master" AutoEventWireup="true" CodeFile="Edit.aspx.cs" Inherits="Admin_ProjectLogo_Edit" %>
...
<div style="width: 100%; float: left;margin-top:30px;">
    <a href="/Admin/ProjectLogo/QLProjectLogo.aspx" style="color:#333333;font-size: 15px;font-weight: bold;">Quản Lý Logo Dự Án Thi Công</a> >> Cập nhật
