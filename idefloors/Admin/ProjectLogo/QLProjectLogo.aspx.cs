...
public partial class Admin_ProjectLogo_QLProjectLogo : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
     ...
     protected void btnDelete_Click(object sender, EventArgs e)
     {
         ...
         Utilities.redirectClient(Page, "/Admin/ProjectLogo/Delete.aspx?ID="+x);
     }
    protected void btnAdd_Click(object sender, EventArgs e)
    {
        Utilities.redirectClient(Page, "/Admin/ProjectLogo/Insert.aspx");
    }
