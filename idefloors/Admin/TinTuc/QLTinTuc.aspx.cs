...
public partial class Admin_TinTuc_QLTinTuc : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
     ...
     protected void btnDelete_Click(object sender, EventArgs e)
     {
         ...
         Utilities.redirectClient(Page, "/Admin/TinTuc/Delete.aspx?ID="+x);
     }
    protected void btnAdd_Click(object sender, EventArgs e)
    {
        Utilities.redirectClient(Page, "/Admin/TinTuc/Insert.aspx");
    }
    private void showData()
    {
        ...
        dt = DataAccess.getNews("-1", _Page, _Limit, ref total);
